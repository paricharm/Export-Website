...
<head>
  ...
  <title>Jute - Classical Jute and Leather Products Exporter </title>
...
<body class="about-page" id="all_page" style="box-shadow:none!important">
  ...
  <main class="main">
    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.webp);">
      <div class="container position-relative">
        ...
        <p>We specialize in modern and innovative designs for ladies' bags, but our skilled artisans and ample raw materials enable us to produce a wide range of products to meet customer needs. Our offerings include promotional bags, office bags, college bags, tote bags, shopping bags, handbags, purses, wallets, lunch bags, and office stationery.
        </p>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.php" style="color:white;">Home</a></li>
            <li class="current">Jute</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
      ...
      <div class="container">
        <div class="row gy-4 justify-content-between align-items-center">
          <div class="col-lg-6 order-lg-1 position-relative" data-aos="zoom-out">
            <img src="./assets/img/jute5.jpg" alt="Image" class=""  style="border-radius:0% !important;height:500px !important;width:100%;">
          <!-- <a href="https://www.youtube.com/watch?v=Y7f98aduVJ8" class="glightbox pulsating-play-btn">
              <span class="play"><i class="bi bi-play-fill"></i></span>
            </a> --> 
          </div>
          <div class="col-lg-5 order-lg-2" data-aos="fade-up" data-aos-delay="100">
            <h2 class="content-title mb-4">The Position of Jute in Bangladesh</h2>
            <p class="mb-4">
              The history of jute cultivation in Bangladesh is over a thousand years old. Since ancient times, Bengali  farmers have been growing jute. Among the various products that Bangladesh exports worldwide, jute  and jute products are among the top. In terms of exports, jute is the third-largest export product of  Bangladesh. 
              In Bangladesh, there are generally three types of jute: local, tossa, and mesta. The fiber of local jute is  white, tossa jute is reddish, and mesta jute has relatively thicker fibers. Each of these varieties is of  excellent quality, and such high-quality jute is not produced anywhere else in the world, with the  majority being cultivated in the Greater Rangpur, Faridpur, Jessore, and Kushtia regions. 
              According to the Food and Agriculture Organization (FAO) of the United Nations, Bangladesh is at the  top of jute production globally, producing 58% of the total jute output in the world. 
            </p>  
          </div>
    ...
    <div class="container"> 
      ...
      <div class="row">  
          <div class="col-12 col-lg-4 col-sm-4 col-md-4 text-center">  
              <img src="./assets/img/juteTPOJIBlocaljute.jpg" alt="Tree" class="" style="border-radius:50% !important;height:200px !important;width:200px !important;" > 
              <h3 class="my-4">local jute</h3>
          </div>          
          <div class="col-12 col-lg-4 col-sm-4 col-md-4 text-center">  
              <img src="./assets/img/juteTPOJIBtossajute.jpeg" alt="Farmer" class="" style="border-radius:50% !important;height:200px !important;width:200px !important;" >
              <h3 class="my-4"> Tossa jute</h3>
            </div>
          <div class="col-12 col-lg-4 col-sm-4 col-md-4 text-center">  
              <img src="./assets/img/juteTPOJIBmestajute.webp" alt="Tree" class="" style="border-radius:50% !important;height:200px !important;width:200px !important;" > 
              <h3 class="my-4">Mesta jute</h3>  
          </div>    
      </div>  
  </div>
    <!-- About 3 Section -->
    <section id="about-3" class="about-3 section">
    <h2 class="content-title my-5 text-center">Why Should You Use Our Jute Products?</h2>
 
    <div class="container text-center" >
    <img src="assets/img/juteWSYUOJP1.avif" alt="Image" class=""  style="border-radius:0% !important;height:500px !important;width:95%; box-shadow:none!important">
    </div>
    <div class="container col-12 col-lg-12 col-md-12">
      <p class="mt-5 px-3 fs-5 text-justify">Among the natural fibers and materials that are environmentally friendly, jute is one of the best. Due to  the global reliance on plastic and synthetic products, the world is on the brink of destruction. Jute could  be an excellent solution to this problem.
        As a biodegradable product, jute easily decomposes and merges with the environment over time. In  contrast, plastic or synthetic bags, being chemical-based, do not decompose easily and can be harmful  to health. A plastic bag takes over 400 years to decompose in soil, while a jute bag integrates seamlessly  with the environment. Additionally, plastic bags are generally used only once, whereas jute bags can be  reused over a thousand times. Furthermore, their strength allows them to easily carry heavy items.Jute bags are breathable, maintaining hygiene while transporting any type of product, especially helping  to preserve the freshness of grocery items. On the other hand, plastic bags are not breathable, making it  difficult to maintain the quality and freshness of the products they carry, which can be detrimental to  health.The main difference between jute bags and plastic bags is that jute is natural while plastic is synthetic.  This artificiality is causing increasing pollution on our planet. Protecting the Earth from this pollution is  possible only through the awareness and changes in the daily lives of people.  </p>
    ...
    <section class="team-15 team section" id="team">
      ...
      <div class="content">
        <div class="container">
          <div class="row">
            <?php
            $select = mysqli_query($con,"select * from product where cat_id=2");
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              <div class="person" style="border:1px solid rgba(0,0,0,0.2)">
                ...
                <div class="person-contents pb-3">
                  <h3><?= $row['pr_name'] ?></h3>
                  <span class="position"><?= $row['pr_desc'] ?></span>
                </div>
              </div>
            </div>
              <?php
    ...
    <section id="services" class="services section">
      ...
      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2>Countries to Which Bangladesh Exports Jute and Jute Products</h2>
      </div><!-- End Section Title -->
      <div class="content">
        <div class="container">
          <div class="row g-0">
              ...
              <div class="service-item">
                ...
                <div class="service-item-icon">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="150" height="100" viewBox="0 0 300 200">
                    ...
                    <!-- Ashoka Chakra -->
                    <circle cx="150" cy="100" r="10" fill="navy"/>
                    <circle cx="150" cy="100" r="12" fill="white"/>
                    <circle cx="150" cy="100" r="10" fill="navy"/>
                    <line x1="150" y1="90" x2="150" y2="110" stroke="navy" stroke-width="1.5"/>
                    <line x1="183" y1="100" x2="117" y2="100" stroke="navy" stroke-width="1.5"/>
                    <!-- 24 spokes of the Ashoka Chakra -->
                    <g stroke="navy" stroke-width="1.5">
                        <line x1="150" y1="100" x2="150" y2="90"/>
                        <line x1="150" y1="100" x2="150" y2="110"/>
                        <line x1="150" y1="100" x2="180" y2="100"/>
                        <line x1="150" y1="100" x2="120" y2="100"/>
                        <line x1="150" y1="100" x2="167" y2="110"/>
                        <line x1="150" y1="100" x2="133" y2="90"/>
                        <line x1="150" y1="100" x2="167" y2="90"/>
                        <line x1="150" y1="100" x2="133" y2="110"/>
                        <line x1="150" y1="100" x2="180" y2="100"/>
                        <line x1="150" y1="100" x2="120" y2="100"/>
                    </g>
                </svg>
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">India</h3>
                  <p>
              ...
              <div class="service-item">
                ...
                <div class="service-item-icon">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="150" height="100" viewBox="0 0 300 200">
                    ...
                    <!-- Yellow star -->
                    <polygon points="50,30 54,45 70,45 56,55 60,70 50,60 40,70 44,55 30,45 46,45" fill="#FFD100"/>
                    <!-- Four smaller stars -->
                    <polygon points="100,40 104,55 120,55 106,65 110,80 100,70 90,80 94,65 80,55 96,55" fill="#FFD100"/>
                    <polygon points="100,80 104,95 120,95 106,105 110,120 100,110 90,120 94,105 80,95 96,95" fill="#FFD100"/>
                    <polygon points="100,120 104,135 120,135 106,145 110,160 100,150 90,160 94,145 80,135 96,135" fill="#FFD100"/>
                    <polygon points="100,160 104,175 120,175 106,185 110,200 100,190 90,200 94,185 80,175 96,175" fill="#FFD100"/>
                </svg>
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">China</h3>
                  <p>
              ...
              <div class="service-item">
                ...
                <div class="service-item-icon">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="150" height="100" viewBox="0 0 300 200">
                    ...
                    <!-- Red circle -->
                    <circle cx="150" cy="100" r="30" fill="#BC002D"/>
                </svg> 
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Japan</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">European Union (EU) countries</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-icon">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="150" height="100" viewBox="0 0 300 200">
                    <!-- Red stripes -->
                    <rect width="300" height="20" fill="#B22234"/>
                    <rect y="40" width="300" height="20" fill="#B22234"/>
                    <rect y="80" width="300" height="20" fill="#B22234"/>
                    <rect y="120" width="300" height="20" fill="#B22234"/>
                    <rect y="160" width="300" height="20" fill="#B22234"/>
                    <!-- White stripes -->
                    <rect y="20" width="300" height="20" fill="#FFFFFF"/>
                    <rect y="60" width="300" height="20" fill="#FFFFFF"/>
                    <rect y="100" width="300" height="20" fill="#FFFFFF"/>
                    <rect y="140" width="300" height="20" fill="#FFFFFF"/>
                    <rect y="180" width="300" height="20" fill="#FFFFFF"/>
                    <!-- Blue rectangle -->
                    ...
                    <g fill="#FFFFFF">
                        ...
                        <polygon points="110,0 112,7 119,7 113,11 115,18 110,14 105,18 107,11 101,7 108,7"/>
                        <polygon points="130,0 132,7 139,7 133,11 135,18 130,14 125,18 127,11 121,7 128,7"/>
                        <polygon points="150,0 152,7 159,7 153,11 155,18 150,14 145,18 147,11 141,7 148,7"/>
                    </g>
                </svg>
                ...
                <div class="service-item-content pb-4">
                  <h3 class="service-heading">United States</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-icon">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="150" height="100" viewBox="0 0 300 200">
                    <!-- Red Rectangle -->
                    <rect width="120" height="200" fill="#FF0000"/>
                    <!-- Green Rectangle -->
                    <rect x="120" width="60" height="200" fill="#007A33"/>
                    <!-- White Rectangle -->
                    <rect x="180" width="60" height="200" fill="#FFFFFF"/>
                    <!-- Black Rectangle -->
                    <rect x="240" width="60" height="200" fill="#000000"/>
                </svg>
                ...
                <div class="service-item-content pb-4">
                  <h3 class="service-heading">Middle Eastern countries</h3>
                  <p>
              ...
              <div class="service-item">
                ...
                <div class="service-item-icon">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="150" height="100" viewBox="0 0 300 200">
                    ...
                    <!-- Red Rectangle -->
                    <rect width="300" height="66.67" fill="#FF0000"/>
                    <!-- White Stripes -->
                    <rect width="300" height="10" y="30" fill="#FFFFFF"/>
                    <rect width="300" height="10" y="60" fill="#FFFFFF"/>
                    <rect width="300" height="10" y="90" fill="#FFFFFF"/>
                    <!-- Shield -->
                    <path d="M150 45 L170 70 L150 95 L130 70 Z" fill="#FF0000"/>
                    <path d="M150 45 L170 70 L150 95 L130 70 Z" stroke="#FFFFFF" stroke-width="2"/>
                ...
                <div class="service-item-content pb-4">
                  <h3 class="service-heading">African countries</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-icon">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="150" height="100" viewBox="0 0 300 200">
                    <!-- Red Stripes -->
                    <rect width="300" height="40" fill="#C8102E"/>
                    <rect y="160" width="300" height="40" fill="#C8102E"/>
                    <!-- White Stripes -->
                    <rect width="300" height="20" y="40" fill="#FFFFFF"/>
                    <rect width="300" height="20" y="140" fill="#FFFFFF"/>
                    <!-- Blue Stripe -->
                    <rect width="300" height="40" y="60" fill="#0033A0"/>
                </svg>
                ...
                <div class="service-item-content pb-4">
                  <h3 class="service-heading">Other Asian countries</h3>
                  <p>
