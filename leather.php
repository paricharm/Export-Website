...
<head>
  ...
  <title> Leather - Classical Jute and Leather Products Exporter </title>
...
<body class="about-page" id="all_page">
  ...
  <main class="main">
    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.webp);">
      <div class="container position-relative">
        ...
        <p>We specialize in stylish and innovative designs for ladies' leather bags. Our skilled artisans create high-quality products using premium leather, allowing us to offer a diverse range to meet customer needs. Our collection includes handbags, totes, office bags, purses, wallets, backpacks, and evening clutches, perfectly blending elegance and functionality for modern women.
        </p>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.php" style="color:white">Home</a></li>
            <li class="current">Leather</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
      ...
      <div class="container" style="padding: 20px;">
        <div class="row gy-4 justify-content-between align-items-center">
          <div class="col-lg-6 order-lg-2 position-relative" data-aos="zoom-out">
            <img src="assets/img/recycle-2.jpg" alt="Image" style="border-radius: 0% !important;">
          </div>
          <div class="col-lg-5 order-lg-1" data-aos="fade-up" data-aos-delay="100">
            <h2 class="content-title mb-4">Why Should You Use Our Leather Products?</h2>
            <ul class="list-unstyled list-check">
              <li>Leather is a highly durable material that can last for many years. With proper care, leather products maintain their excellent condition over time.</li>
              <li>Leather items, such as shoes and gloves, are known for their comfort. The softness and flexibility of leather provide convenience and ease of use.</li>
              <li>As a natural material, leather is breathable, allowing it to absorb sweat and facilitate airflow, which helps regulate body temperature.</li>
              <li>Leather offers a natural, elegant look that can be crafted into various designs. Additionally, leather products are easy to clean and maintain, ensuring longevity.</li>
            </ul>

            <p><a href="#" class="btn-cta">See More</a></p>
          </div>
        </div>
      </div>
      ...
      <div class="container" style="padding: 20px;">
        <div class="row gy-4 justify-content-between align-items-center">
          <div class="col-lg-6  position-relative" data-aos="zoom-out">
            <img src="assets/img/goods.avif" alt="Image" style="border-radius: 0% !important;">
          </div>
          <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
            <h2 class="content-title mb-4">We Are Your Best Partner in Leather Products</h2>
            <ul class="list-unstyled list-check">
              <li>Bangladesh is a leading leather-producing country, and our company has extensive experience in the industry, ensuring high-quality products.</li>
              <li> We have a talented workforce and specialists who are dedicated to crafting leather goods, enhancing the quality and innovation of our designs.</li>
              <li>Our team includes modern designers who create stylish and contemporary leather products that meet current market trends.</li>
              <li>We offer high-quality leather products at reasonable prices, making our partnership not only beneficial in terms of quality and design but also in terms of cost-effectiveness.</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <section class="team-15 team section" id="team">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Our Latest Leather Products </h2>
    ...
    <section id="services" class="services section">
      ...
      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2>Countries to Which Bangladesh Exports Leather and Leather Products: </h2>
      </div><!-- End Section Title -->
      <div class="content">
        <div class="container">
          <div class="row g-0">
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Italy</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Germany</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Spain</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">France</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Netherlands</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Poland</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Canada</h3>
                  <p>
          ...
          <div class="row g-0">
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Argentina</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Brazil</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Uruguay</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Saudi Arabia</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">South Korea</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">United Arab Emirates</h3>
                  <p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">South Africa</h3>
                  <p>
